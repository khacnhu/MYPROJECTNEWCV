    ...
    <div className = "header" >
        <div className='headerContain' >
            ...
            <div className = "headerList" >
                <CgDarkMode className='darkModeIcon' onClick={()=>changeDarkMode()} />
                <Link to = "/" style={{textDecoration: "none"}} className = "Link" >Home</Link>
                {
                    user?.result?._id ? (
                        <>
                            <Link to = "/addTour" className = "Link" >AddTour</Link>
                ...
                }
                {
                    user?.result?._id ? (
                        ...
                        <>
                            ...
                            <Link to = "/register" style={{textDecoration: "none"}} className = "Link" >Register</Link>    
                        </>
                ...
                <div className = "headerUser" >
                    {
                        user?.result?.name ? (
                            ...
                            <div className = "ListCheckUserAccount" >
                                ...
                                <div>
                                    <FaListAlt className='iconFaListAlt' />
